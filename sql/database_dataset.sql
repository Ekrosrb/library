...
VALUES
('Harry Potter and the Half-Blood Prince (Harry Potter #6)', 'J.K. Rowling/Mary GrandPré', 'book edition inc', 'Harry Potter and the Half-Blood Prince is a fantasy novel written by British author J.K. Rowling and the sixth and penultimate novel in the Harry Potter series. Set during Harry Potter''s sixth year at Hogwarts, the novel explores the past of the boy wizard''s nemesis, Lord Voldemort, and Harry''s preparations for the final battle against Voldemort alongside his headmaster and mentor Albus Dumbledore.', 'Гарри Поттер и принц-полукровка - роман в жанре фэнтези, написанный британским писателем Дж.К. Роулинг и шестой и предпоследний роман в серии о Гарри Поттере. Действие романа происходит на шестом курсе Гарри Поттера в Хогвартсе. В нем рассказывается о прошлом заклятого врага мальчика-волшебника, лорда Волдеморта, и подготовки Гарри к финальной битве против Волдеморта вместе с его директором и наставником Альбусом Дамблдором.', 2),
('Harry Potter and the Order of the Phoenix (Harry Potter #5)', 'J.K. Rowling/Mary GrandPré', 'book edition', 'Harry Potter and the Order of the Phoenix is a fantasy novel written by British author J. K. Rowling and the fifth novel in the Harry Potter series. It follows Harry Potter''s struggles through his fifth year at Hogwarts School of Witchcraft and Wizardry, including the surreptitious return of the antagonist Lord Voldemort, O.W.L. exams, and an obstructive Ministry of Magic.', 'Гарри Поттер и Орден Феникса - это фантастический роман британской писательницы Дж. К. Роулинг, пятый роман из серии о Гарри Поттере. Он следует за борьбой Гарри Поттера в течение его пятого года в школе чародейства и волшебства Хогвартс, включая тайное возвращение лорда-антагониста Волан-де-Морта, С.О.В. экзамены и мешающее Министерство Магии.', 5),
('Harry Potter and the Chamber of Secrets (Harry Potter #2)', 'J.K. Rowling', 'book inc', 'Harry Potter and the Chamber of Secrets is a fantasy novel written by British author J. K. Rowling and the second novel in the Harry Potter series. The plot follows Harry''s second year at Hogwarts School of Witchcraft and Wizardry, during which a series of messages on the walls of the school''s corridors warn that the "Chamber of Secrets" has been opened and that the "heir of Slytherin" would kill all pupils who do not come from all-magical families. These threats are found after attacks that leave residents of the school petrified. Throughout the year, Harry and his friends Ron and Hermione investigate the attacks.', 'Гарри Поттер и Тайная комната - это фантастический роман британской писательницы Дж. К. Роулинг, второй роман из серии о Гарри Поттере. Сюжет следует за вторым годом Гарри в Школе чародейства и волшебства Хогвартс, в течение которого на стенах школьных коридоров появляется серия сообщений, предупреждающих, что «Тайная комната» открыта и что «наследник Слизерина» убьет всех учеников. которые не происходят из чисто магических семей. Эти угрозы обнаруживаются после нападений, в результате которых жители школы приходят в ужас. В течение года Гарри и его друзья Рон и Гермиона расследуют нападения.', 3),
('Harry Potter and the Prisoner of Azkaban (Harry Potter #3)', 'J.K. Rowling/Mary GrandPré', ' edition inc', 'Harry Potter and the Prisoner of Azkaban is a fantasy novel written by British author J. K. Rowling and is the third in the Harry Potter series. The book follows Harry Potter, a young wizard, in his third year at Hogwarts School of Witchcraft and Wizardry. Along with friends Ronald Weasley and Hermione Granger, Harry investigates Sirius Black, an escaped prisoner from Azkaban, the wizard prison, believed to be one of Lord Voldemort''s old allies.', 'Гарри Поттер и узник Азкабана - это фантастический роман британской писательницы Дж. К. Роулинг, третий в серии о Гарри Поттере. Книга рассказывает о Гарри Поттере, молодом волшебнике, который учится на третьем курсе школы чародейства и волшебства Хогвартс. Вместе с друзьями Рональдом Уизли и Гермионой Грейнджер Гарри исследует Сириуса Блэка, сбежавшего заключенного из Азкабана, волшебной тюрьмы, который, как полагают, был одним из старых союзников лорда Волан-де-Морта.', 7),
('Unauthorized Harry Potter Book Seven News: "Half-Blood Prince" Analysis and Speculation', 'W. Frederick Zimmerman', 'book edition inc', 'This book contains the results of my research. Over the years and especially after publication of "Half-Blood Prince", J. K. Rowling and others have let slip quite a bit of information about the series. I think I was able to pull together a lot of interesting information. You will notice that there are many quotations and that wherever possible I have provided an "attribution"that is, I have identified author, title, date, and place of publication (often Internet). That way, you can judge for yourself whether my sources are solid.', 'В этой книге собраны результаты моих исследований. Спустя годы, особенно после публикации «Принца-полукровки», Дж. К. Роулинг и другие упустили довольно много информации о сериале. Думаю, мне удалось собрать много интересной информации. Вы заметите, что существует много цитат и что я везде, где это возможно, указывал «авторство», то есть указал автора, название, дату и место публикации (часто в Интернете). Таким образом, вы можете сами судить, надежны ли мои источники.', 2),
...
('Molly Hatchet - 5 of the Best', 'Molly Hatchet', 'book edition', 'super book2', 'супер книга 2', 0),
